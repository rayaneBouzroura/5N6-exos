...
class _MyHomePageState extends State<MyHomePage> {
  ...
  //track the position of the rabbit
  int attempts = 0;
  int found = 0;
  bool showRabbit = true;//indique si on affiche le lapin
  bool _isHovered = false;//indique si le container est hover par la souris
  int _hoveredIndex = -1; //hold

  double _rabbitOpacity = 0.0;
  List<bool> clickedContainers = List.generate(
      9, (index) => false); //tracks clicked ou pas pour l'animation de chaque container

  void _randomizeLeLapinou() {
    rabbitPosition = Random().nextInt(9);//donne une position de lapin random
  }
